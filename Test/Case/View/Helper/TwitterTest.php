...
App::import('Helper', 'Twim.Twitter');
...
class TwitterTest extends CakeTestCase {
    ...
    function testLinkify_username_and_hashtag() {
    ...
    function testLinkify_username_and_hashtag_no_space() {
        $value = '@username#hashtag';
        $result = '<a href="http://twitter.com/username">@username</a><a href="http://search.twitter.com/search?q=%23hashtag">#hashtag</a>';
        $this->assertEqual($this->Twitter->linkify($value), $result);
    }

    function testLinkify_username_and_url() {
    ...
    function testLinkify_url_and_hashtag() {
    ...
    function testLinkify_double_username() {
    ...
    function testLinkify_double_hashtag() {
...
OUTPUT_EOL;
    ...
    function testTweetButton_null_label() {
        $ok = <<<OUTPUT_EOL
<a href="http://twitter.com/share?count=horizontal&amp;lang=en" class="twitter-share-button">Tweet</a>
OUTPUT_EOL;
    ...
    function testTweetButton_empty_label() {
        $ok = <<<OUTPUT_EOL
<a href="http://twitter.com/share?count=horizontal&amp;lang=en" class="twitter-share-button">Tweet</a>
OUTPUT_EOL;
        $result = $this->Twitter->tweetButton('');
    ...
    function testTweetButton_empty_option() {
        $ok = <<<OUTPUT_EOL
<a href="http://twitter.com/share?count=horizontal&amp;lang=en" class="twitter-share-button">Tweet</a>
OUTPUT_EOL;
    ...
    function testTweetButton_null_query_flag() {
        $ok = <<<OUTPUT_EOL
<a href="http://twitter.com/share?count=horizontal&amp;lang=en" class="twitter-share-button">Tweet</a>
OUTPUT_EOL;
    ...
    function testTweetButton_null_inline_flag() {
        $ok = <<<OUTPUT_EOL
<a href="http://twitter.com/share?count=horizontal&amp;lang=en" class="twitter-share-button">Tweet</a>
OUTPUT_EOL;
...
OUTPUT_EOL;
    ...
    function testTweetButton_test_options_full() {
        $options = array(
            'class' => 'testClass',
            'url' => 'testUrl',
            'via' => 'testVia',
...
OUTPUT_EOL;
    ...
    function testTweetButton_test_options_count_none() {
        $options = array(
            'count' => 'none',
        );
        $result = $this->Twitter->tweetButton(null, $options);
...
OUTPUT_EOL;
    ...
    function testTweetButton_test_options_count_vertical() {
        $options = array(
            'count' => 'vertical',
        );
        $result = $this->Twitter->tweetButton(null, $options);
...
OUTPUT_EOL;
    ...
    function testTweetButton_options_count_top() {
        $options = array(
            'count' => 'top',
        );
        $result = $this->Twitter->tweetButton(null, $options);
...
OUTPUT_EOL;
    ...
    function testTweetButton_data_attributes() {
...
OUTPUT_EOL;
    ...
    function testTweetButton_inline() {
